<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-purple-700 fixed w-screen bg-background-primary z-10">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div>
          <g-link v-if="theme === 'theme-light'" to="/"><g-image src="../../static/logo_half.svg" class="w-40" alt="logo" /></g-link>
          <g-link v-else to="/"><g-image src="../../static/logo_half_gray.svg" class="w-40" alt="logo" /></g-link>
        </div>
    ...
    <div class="flex-grow mt-16 md:mt-32">
      <slot/>
    </div>
    ...
    <footer class="bg-purple-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          ...
          <li class="mr-8">
            <a href="mailto:lilafuches@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/lila-fuches" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/lilafuches" target="_blank" class="text-white hover:text-gray-400">
...
<script>
  (adsbygoogle = window.adsbygoogle || []).push({
    google_ad_client: "ca-pub-1678833345168179",
